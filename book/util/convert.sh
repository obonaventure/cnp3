...
# svg format
	...
	if [ ${W} -gt 700 ]; then
		${INKSCAPE} ${1} --export-width=700 --export-area-snap --export-area-drawing --export-png=${DIRNAME}/${BASENAME}.png
		${INKSCAPE} ${1} --export-width=700 --export-area-snap --export-area-drawing --export-pdf=${DIRNAME}/${BASENAME}.pdf
