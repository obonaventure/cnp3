...
.. msc::
    ...
    a=>b [ label = "DATA.request(0)" ] ,
    b>>c [ label = "0", arcskip=1];
    c=>d [ label = "DATA.indication(0)" ];
...
.. figure:: svg/transport-fig-007-c.*
   :align: center
   :scale: 80 
...
.. figure:: svg/transport-fig-019.*
   :align: center
   :scale: 70 

   Limitations of retransmission timers 

.. todo:: corriger au-dessus
