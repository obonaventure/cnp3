...
.. code-block:: python
 ...
 orig = F.DireccionOrigen
 dest = F.DireccionDestino
...
Además del identificador discutido anteriormente, el administrador de la red puede configurar un `costo` a ser asociado a cada puerto de un switch. Normalmente, el `costo` de un puerto depende de su ancho de banda, y el estándar [802.1d]_ recomienda los valores siguientes. Por supuesto, el administrador puede elegir otros valores. Usaremos en esta sección la notación `costo[p]` para indicar el costo asociado al puerto `p`.
